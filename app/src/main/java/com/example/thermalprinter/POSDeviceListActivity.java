...
public class POSDeviceListActivity extends AppCompatActivity {
    // Debugging
    private static final String TAG = "POSDeviceListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            findViewById(R.id.paired_pos_devices).setVisibility(View.VISIBLE);
    ...
    private void permissionChecking() {
        ...
        if (CURRENT_ANDROID_VERSION >= Build.VERSION_CODES.M) { //Marshmallow
            ...
            if (ContextCompat.checkSelfPermission(POSDeviceListActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(POSDeviceListActivity.this,
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ActivityCompat.requestPermissions(POSDeviceListActivity.this,
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(POSDeviceListActivity.this, "Permission is Denied!", Toast.LENGTH_LONG).show();
                }
                return;
            }
